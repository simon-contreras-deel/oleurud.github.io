...
Vb.prototype.get=function(){var a;0<this.h?(this.h--,a=this.f,this.f=a.next,a.next=null):a=this.j();return a};function Wb(){this.h=this.f=null}
...
var bc=!1,cc=new Wb;function dc(){for(var a=null;a=cc.remove();){try{a.f.call(a.scope)}catch(c){Sb(c)}var b=Yb;b.l(a);b.h<b.o&&(b.h++,a.next=b.f,b.f=a)}bc=!1}
...
function oc(){var a={},b="FLASH_UPGRADE"in ic?ic.FLASH_UPGRADE:'You need to upgrade your Adobe Flash Player to watchthis video. <br> <a href="https://web.archive.org/web/20160125130826/http://get.adobe.com/flashplayer/">Download it from Adobe.</a>';if(b)for(var c in a)b=b.replace(new RegExp("\\$"+c,"gi"),function(){return a[c]});
return b}
...
Bc("//web.archive.org/web/20160125130826/https://static.doubleclick.net/instream/ad_status.js",a);ce.push(be(function(){de||"google_ad_status"in window||(Ic("//web.archive.org/web/20160125130826/https://static.doubleclick.net/instream/ad_status.js",a),jc("DCLKSTAT",3))}))}
...
function eh(a){var b=window.location.protocol,c=S.getEntriesByType("resource"),d=c.filter(function(a){return 0==a.name.indexOf(b+"//web.archive.org/web/20160125130826/https://fonts.googleapis.com/css?family=")})[0],c=c.filter(function(a){return 0==a.name.indexOf(b+"//web.archive.org/web/20160125130826/https://fonts.gstatic.com/s/")}).reduce(function(a,b){return b.duration>a.duration?b:a},{duration:0});
...
function ch(a){if(H("DEBUG_CSI_DATA")){var b=r("yt.timing.csiData");b||(b=[],q("yt.timing.csiData",b,void 0));b.push({page:location.href,time:new Date,args:a})}H("EXP_DEFER_CSI_PING")&&(J(r("yt.timing.deferredPingTimer_")),q("yt.timing.deferredPingArgs_",null,void 0));var c="https:"==window.location.protocol?"https://web.archive.org/web/20160125130826/https://gg.google.com/csi":"https://web.archive.org/web/20160125130826/http://csi.gstatic.com/csi",c=H("CSI_LOG_WITH_YT")?"/csi_204":c,b="",d;for(d in a)b+="&"+d+"="+a[d];a=c+"?"+b.substring(1);b=H("DOUBLE_LOG_CSI")?"/csi_204?"+b.substring(1):
null;window.navigator&&window.navigator.sendBeacon?(Kg(a),b&&Kg(b)):(a&&Lg(a),b&&b&&Lg(b));q("yt.timing.pingSent_",!0,void 0)}
...
g.He=function(){wh(this);this.B="unsupported";var a='Adobe Flash Player or an HTML5 supported browser is required for video playback. <br> <a href="https://web.archive.org/web/20160125130826/http://get.adobe.com/flashplayer/">Get the latest Flash Player</a> <br> <a href="/html5">Learn more about upgrading to an HTML5 browser</a>',b=navigator.userAgent.match(/Version\/(\d).*Safari/);b&&5<=parseInt(b[1],10)&&(a='Adobe Flash Player or QuickTime is required for video playback. <br> <a href="https://web.archive.org/web/20160125130826/http://get.adobe.com/flashplayer/"> Get the latest Flash Player</a> <br> <a href="https://web.archive.org/web/20160125130826/http://www.apple.com/quicktime/download/">Get the latest version of QuickTime</a>');
...
function vn(a,b){if(2==b||9==b){var c=null;a.T&&(c=null);var d=v(a.Be,a);c||(c=new hg("//web.archive.org/web/20160125130826/https://www.google.com/images/cleardot.gif"),Ag(c));pn(c.toString(),1E4,d)}else X();ao(a,b)}
...
function Xo(a,b,c){var d=Z,e="";Wo(d);if(ck(d.h,a)){if(!e){var f=e=Wj();Pl();var h=Yl(a),k=Ml();if(k&&h){var l=new cast.Receiver(h.id,h.name),l=new cast.LaunchRequest("YouTube",l);l.parameters="pairingCode="+f;l.description=new cast.LaunchDescription;l.description.text=document.title;b&&(l.parameters+="&v="+b,c&&(l.parameters+="&t="+Math.round(c)),l.description.url="https://web.archive.org/web/20160125130826/http://i.ytimg.com/vi/"+b+"/default.jpg");"UNKNOWN"!=h.status&&(h.status="UNKNOWN",Ul(h),K("yt-remote-cast-device-status-update",h));
...
function $q(){var a=H("PLAYER_CONFIG",void 0),b=H("REVERSE_MOBIUS_PERCENT",void 0);if(bg&&100*Math.random()<b)try{Ud("//web.archive.org/web/20160125130826/https://googleads.g.doubleclick.net/pagead/id",{format:"RAW",method:"GET",aa:oq,withCredentials:!0})}catch(e){}if(H("REQUEST_POST_MESSAGE_ORIGIN")){if(!Vq){Vq=new Gi;Vq.f=$q;return}Vq.origin&&"*"!=Vq.origin&&(a.args.post_message_origin=Vq.origin)}var c=document.referrer,b=H("POST_MESSAGE_ORIGIN"),d=!1;u(c)&&u(b)&&-1<c.indexOf(b)&&Gg(b)&&Gg(c)&&(d=!0);window!=window.top&&c&&c!=document.URL&&
...
Wq;
a&&a.sendAbandonmentPing&&a.sendAbandonmentPing();H("PL_ATT")&&(Jc=null);for(var a=0,b=ce.length;a<b;a++){var c=ce[a],d=r("yt.scheduler.instance.cancelJob");d?d(c):J(c)}ce.length=0;a=Fc("//web.archive.org/web/20160125130826/https://static.doubleclick.net/instream/ad_status.js");if(b=document.getElementById(a))Ac(a),b.parentNode.removeChild(b);de=!1;jc("DCLKSTAT",0);xc(Dq);Dq.length=0;Ug(Eq);Eq.length=0;Cq=!1;Rp&&(Rp.removeEventListener("SUBSCRIBE",Vp),Rp.removeEventListener("UNSUBSCRIBE",Xp));Rp=null;Ug(Sp);Sp.length=0;Zq||(xc(Mp),Mp.length=
...
/*
     FILE ARCHIVED ON 13:08:26 Jan 25, 2016 AND RETRIEVED FROM THE
     INTERNET ARCHIVE ON 22:31:21 Mar 04, 2018.
