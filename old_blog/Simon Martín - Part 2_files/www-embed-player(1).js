...
Wb("//web.archive.org/web/20161122235858/https://static.doubleclick.net/instream/ad_status.js",a);mg.push(lg(function(){ng||"google_ad_status"in window||(cc("//web.archive.org/web/20161122235858/https://static.doubleclick.net/instream/ad_status.js",a),Eb("DCLKSTAT",3))},5E3))}
...
Jf("//web.archive.org/web/20161122235858/https://googleads.g.doubleclick.net/pagead/id",a)})}
...
Wk;
a&&a.sendAbandonmentPing&&a.sendAbandonmentPing();F("PL_ATT")&&(dc=null);for(var a=0,b=mg.length;a<b;a++){var c=mg[a];if(!isNaN(c)){var d=r("yt.scheduler.instance.cancelJob");d?d(c):Hb(c)}}mg.length=0;a=$b("//web.archive.org/web/20161122235858/https://static.doubleclick.net/instream/ad_status.js");if(b=document.getElementById(a))Vb(a),b.parentNode.removeChild(b);ng=!1;Eb("DCLKSTAT",0);Sb(Fk);Fk.length=0;rh(Gk);Gk.length=0;Ek=!1;sj&&(sj.removeEventListener("SUBSCRIBE",wj),sj.removeEventListener("UNSUBSCRIBE",yj));sj=null;rh(tj);tj.length=0;
...
/*
     FILE ARCHIVED ON 23:58:58 Nov 22, 2016 AND RETRIEVED FROM THE
     INTERNET ARCHIVE ON 22:40:43 Mar 04, 2018.
