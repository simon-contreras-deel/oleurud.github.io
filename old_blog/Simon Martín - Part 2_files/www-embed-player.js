...
function pc(){var a={},b="FLASH_UPGRADE"in jc?jc.FLASH_UPGRADE:'You need to upgrade your Adobe Flash Player to watchthis video. <br> <a href="https://web.archive.org/web/20160117052727/http://get.adobe.com/flashplayer/">Download it from Adobe.</a>';if(b)for(var c in a)b=b.replace(new RegExp("\\$"+c,"gi"),function(){return a[c]});
return b}
...
Cc("//web.archive.org/web/20160117052727/https://static.doubleclick.net/instream/ad_status.js",a);de.push(ce(function(){ee||"google_ad_status"in window||(Jc("//web.archive.org/web/20160117052727/https://static.doubleclick.net/instream/ad_status.js",a),kc("DCLKSTAT",3))}))}
...
function Dh(a){var b=window.location.protocol,c=R.getEntriesByType("resource"),d=c.filter(function(a){return 0==a.name.indexOf(b+"//web.archive.org/web/20160117052727/https://fonts.googleapis.com/css?family=")})[0],c=c.filter(function(a){return 0==a.name.indexOf(b+"//web.archive.org/web/20160117052727/https://fonts.gstatic.com/s/")}).reduce(function(a,b){return b.duration>a.duration?b:a},{duration:0});
...
g.Ge=function(){Vh(this);this.A="unsupported";var a='Adobe Flash Player or an HTML5 supported browser is required for video playback. <br> <a href="https://web.archive.org/web/20160117052727/http://get.adobe.com/flashplayer/">Get the latest Flash Player</a> <br> <a href="/html5">Learn more about upgrading to an HTML5 browser</a>',b=navigator.userAgent.match(/Version\/(\d).*Safari/);b&&5<=parseInt(b[1],10)&&(a='Adobe Flash Player or QuickTime is required for video playback. <br> <a href="https://web.archive.org/web/20160117052727/http://get.adobe.com/flashplayer/"> Get the latest Flash Player</a> <br> <a href="https://web.archive.org/web/20160117052727/http://www.apple.com/quicktime/download/">Get the latest version of QuickTime</a>');
...
;var Dj=document.currentScript&&-1!=document.currentScript.src.indexOf("?loadGamesSDK")?"/cast_game_sender.js":"/cast_sender.js",Ej=0<window.location.hash.indexOf("__CastInternalExtensionIds__"),Fj=["boadgeojelhgndaghljhdicfkmllpafd","dliochdbjfkdbacpmhlcpmleaejidimm"],Gj=["hfaagokkkhdbgiakmmlclaapfelnkoah","fmfcbgogabcbclcofgocippekhfcmgfj","enhhojjnijigcajfphajepfemndkmdlo","eojlgccfgnjlphjnlopmadngcgmmdgpk"],Hj=["pkedcjkdefgpdelpbcmbmeomcjbeemfm","fjhoaacokmgbjemoflkofnenfaiekifl"],Ij=["ekpaaapppgpmolpcldedioblbkmijaca",
"lhkfccafpkdlaodkicmokbmfapjadkij","ibiljbkambkbohapfhoonkcpcikdglop","enhhojjnijigcajfphajepfemndkmdlo"],Jj=Ej?Fj.concat(Gj):Fj,Kj=Ej?Ij.concat(Hj):Hj,Lj=window.navigator.presentation?Jj.concat(Kj):Jj;function Mj(a){window.chrome?Nj(0,a):a(null)}
...
function sn(a,b){if(2==b||9==b){var c=null;a.T&&(c=null);var d=v(a.Ae,a);c||(c=new Gg("//web.archive.org/web/20160117052727/https://www.google.com/images/cleardot.gif"),Zg(c));mn(c.toString(),1E4,d)}else X();Yn(a,b)}
...
function Uo(a,b,c){var d=Z,e="";To(d);if(Ak(d.h,a)){if(!e){var f=e=uk();mm();var h=vm(a),k=jm();if(k&&h){var l=new cast.Receiver(h.id,h.name),l=new cast.LaunchRequest("YouTube",l);l.parameters="pairingCode="+f;l.description=new cast.LaunchDescription;l.description.text=document.title;b&&(l.parameters+="&v="+b,c&&(l.parameters+="&t="+Math.round(c)),l.description.url="https://web.archive.org/web/20160117052727/http://i.ytimg.com/vi/"+b+"/default.jpg");"UNKNOWN"!=h.status&&(h.status="UNKNOWN",rm(h),J("yt-remote-cast-device-status-update",h));
...
function Xq(){var a=F("PLAYER_CONFIG",void 0),b=F("REVERSE_MOBIUS_PERCENT",void 0);if(Dg&&100*Math.random()<b)try{Vd("//web.archive.org/web/20160117052727/https://googleads.g.doubleclick.net/pagead/id",{format:"RAW",method:"GET",ca:lq,withCredentials:!0})}catch(e){}if(F("REQUEST_POST_MESSAGE_ORIGIN")){if(!Sq){Sq=new dj;Sq.f=Xq;return}Sq.origin&&"*"!=Sq.origin&&(a.args.post_message_origin=Sq.origin)}var c=document.referrer,b=F("POST_MESSAGE_ORIGIN"),d=!1;u(c)&&u(b)&&-1<c.indexOf(b)&&eh(b)&&eh(c)&&(d=!0);window!=window.top&&c&&c!=document.URL&&
...
Tq;
a&&a.sendAbandonmentPing&&a.sendAbandonmentPing();F("PL_ATT")&&(Kc=null);for(var a=0,b=de.length;a<b;a++){var c=de[a],d=r("yt.scheduler.instance.cancelJob");d?d(c):I(c)}de.length=0;a=Gc("//web.archive.org/web/20160117052727/https://static.doubleclick.net/instream/ad_status.js");if(b=document.getElementById(a))Bc(a),b.parentNode.removeChild(b);ee=!1;kc("DCLKSTAT",0);yc(Aq);Aq.length=0;sh(Bq);Bq.length=0;zq=!1;Op&&(Op.removeEventListener("SUBSCRIBE",Sp),Op.removeEventListener("UNSUBSCRIBE",Up));Op=null;sh(Pp);Pp.length=0;Wq||(yc(Jp),Jp.length=
...
/*
     FILE ARCHIVED ON 05:27:27 Jan 17, 2016 AND RETRIEVED FROM THE
     INTERNET ARCHIVE ON 22:40:11 Mar 04, 2018.
